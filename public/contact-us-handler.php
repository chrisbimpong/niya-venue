...
<head>
    <!-- Page Title -->
    <title>NiYa | Book Your Perfect Venue</title>
    
    <!-- Meta Tags -->
    <meta charset="utf-8">
    <meta name="keywords" content="HTML5 Template" />
    <meta name="description" content="NiYa | Book Your Perfect Venue">
                        ...
                        <ul class="menu">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul>
                                    ...
                                    <li><a href="meetings-list-view.html">List View</a></li>
                                    <li><a href="meetings-grid-view.html">Grid View</a></li>
                                    <li><a href="meetings-block-view.html">Block View</a></li>
                                    <li><a href="meeting-detailed.html">Detailed</a></li>
                                    <li><a href="venue-listing.html">Booking</a></li>
